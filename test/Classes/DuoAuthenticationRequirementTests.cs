...
namespace Test.Classes
{
    ...
    public class DuoAuthenticationRequirementTests
    {
        ...
        {
            var user = EntraIdClaimMapper.BuildPrincipal("jdoe", hasMultifactor: true, DateTime.UtcNow);
        ...
        {
            var user = EntraIdClaimMapper.BuildPrincipal("jdoe", hasMultifactor: false, DateTime.UtcNow);

...
public partial class VwAllJobPosOrg
{
    ...
    public DateTime? JobInsertTimestamp { get; set; }

    public DateTime? JobUpdateTimestamp { get; set; }

    public DateTime? JobSrcUpdateTimestamp { get; set; }

    public string? JobActnCd { get; set; }

    public string? JobActnRsnCd { get; set; }

    public string? JobActnDesc { get; set; }

    public string? JobActnRsnDesc { get; set; }
    ...
    public string? JobCdEffStatCd { get; set; }

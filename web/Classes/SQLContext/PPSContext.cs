...
public partial class PPSContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<VwUserinfoUser>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_userinfo_user");
            ...
            entity.Property(e => e.Inactivated)
                .HasColumnType("datetime")
                .HasColumnName("inactivated");
            entity.Property(e => e.Isprimary).HasColumnName("ISPRIMARY");
            entity.Property(e => e.JobStatus)
                .HasMaxLength(1)
                .HasColumnName("JOB_STATUS");
            ...
            entity.Property(e => e.ReportsToName)
                .HasMaxLength(61)
                .HasColumnName("reportsToName");
            entity.Property(e => e.ReportsToPosition)
                .HasMaxLength(30)
                .HasColumnName("reportsToPosition");

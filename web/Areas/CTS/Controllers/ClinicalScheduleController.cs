...
namespace Viper.Areas.CTS.Controllers
{
	...
	[Permission(Allow = "SVMSecure.ClnSchd")] 
	public class ClinicalScheduleController : ApiController
	{
		...
		/// <returns></returns>
		[HttpGet("student")]
		public async Task<ActionResult<List<StudentSchedule>>> GetStudentSchedule(int? classYear, string? mothraId, int? rotationId, int? serviceId, int? weekId, DateTime? startDate,
			DateTime? endDate)
		{

...
{
    public class UserInfoResultWithIDs: UserInfoResult
    {
        ...
        public UserInfoResultWithIDs()
        {

        }

        [SupportedOSPlatform("windows")]
        public UserInfoResultWithIDs(AaudUser? aaudUser, LdapUserContact? ldapUserContact)

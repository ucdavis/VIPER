...
REM  15. Add Notes Column - Add optional Notes column to Records table for instructor notes
REM
REM Usage:
...
echo  15. Add Notes Column - Add optional Notes column to Records table for instructor notes
echo.

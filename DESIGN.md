...
**The Root-Scale Rule.** Size in rem, never px, because the root font-size itself is the responsive mechanism. A px value silently opts out of the 14px to 16px step at 768px and breaks density parity between phone and desktop.

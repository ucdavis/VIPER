...
<template>
    ...
    <q-card flat>
        <q-form @submit="save()">
            ...
            <div class="row">
                <q-toggle
                    label="Assessment"
                    v-model="bundle.assessment"
                ></q-toggle>
            </div>
            <div class="row">
                <q-toggle
                    label="Show for Clinical Encounters"
                    v-model="bundle.clinical"
                ></q-toggle>
            </div>
            <div class="row">
                <q-toggle
                    label="Milestone"
                    v-model="bundle.milestone"
                ></q-toggle>
            </div>
    ...
    >
        ...
        <template #body-cell-compcount="props">
            <q-td :props="props">
                <q-btn
                    dense
                    size="sm"
        ...
        <template #body-cell-clinical="props">
            <q-td :props="props">
                <q-icon
        ...
        <template #body-cell-assessment="props">
            <q-td :props="props">
                <q-icon
        ...
        <template #body-cell-milestone="props">
            <q-td :props="props">
                <q-icon

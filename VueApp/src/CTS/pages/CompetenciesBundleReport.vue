...
const filterStatus = computed(() => {
    ...
    return {
        ...
        message: hasFilters ? "Showing competencies with selected flags" : "Showing competencies not in any bundle",
    }
})
        ...
        <q-card>
            ...
            >
                ...
                >
                    <template #body-cell-name="props">
                        <q-td :props="props">
                            <div class="col-competency-name">
                                <q-tooltip
                                    v-if="props.value && props.value.length > 40"
                                    anchor="top middle"
                                    self="bottom middle"
                                >
                                    {{ props.value }}
                    ...
                    <template #body-cell-bundles="props">
                        <q-td :props="props">
                            <div
                            ...
                            <div
                                v-else
                                class="row q-gutter-xs bundle-chips"
                            >
                                <q-chip
                ...
                <div
                    v-if="processedCompetencies.length === 0"
                    class="full-width row flex-center text-grey q-gutter-sm q-pa-xl"
                >
                    <q-icon
                        size="2em"
                        name="warning"

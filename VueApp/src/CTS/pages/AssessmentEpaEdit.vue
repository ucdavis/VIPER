            ...
            <div class="row justify-between items-end q-mb-lg">
                ...
                <div class="col-12 col-md-6 col-lg-3 text-right">
                    <div class="row items-end">
                        <div class="col-10 text-body1">Assessment for {{ studentEpa.studentName }}</div>
                        <div class="col-2">
                            <q-avatar
                                v-show="studentEpa.studentMailId"
                                rounded
                                class="fit"
                            >
                                <q-img
                                    :src="photoBaseUrl + studentEpa.studentMailId + '&altphoto=1'"
            ...
            <q-form @submit="submitEpa">
                ...
                <div class="row">
                    ...
                    <q-input
                        ...
                        v-model="studentEpa.encounterDate"

...
const cols: QTableProps["columns"] = [
    ...
    { name: "level", label: "Level", field: "level", align: "left", sortable: true },
    {
        ...
        label: "Student Associations (College/Major/Level/Class)",
        field: "studentAssociation",
        align: "left",
        sortable: true,
    },
]
    ...
    r.result.forEach((std: StudentInfo) => {
        std.studentAssociations?.forEach((sa: StudentAssociation, i: number) => {
            newValue.push({
                ...
                studentType: std.studentType === null || std.studentType[i] === undefined ? "" : std.studentType[i],
...
<template>
    ...
    >
        ...
        <template #body-cell-studentAssociations="props">
            <q-td :props="props">

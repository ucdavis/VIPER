        ...
        <div v-else>
            ...
            <div v-if="selectedClinician">
                ...
                <ScheduleView
                    ...
                    :error="scheduleError"
                    :can-edit="!isPastYear"
                    :can-view-history="permissionsStore.hasManagePermission"
                    :history-context-id="selectedClinician?.mothraId ?? null"
                    :history-context-label="selectedClinician?.fullName ?? ''"
                    :show-legend="true"

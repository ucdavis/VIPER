<template>
        ...
        <q-card style="width: 100%; max-width: 900px; position: relative">
            ...
            <q-card-section class="q-pb-none q-pr-xl">
                ...
                <div class="text-caption text-grey-7">
                    Search for courses you are listed as an instructor for in Banner. DVM/VET courses are excluded and
                    must be imported by department staff.
                </div>
            </q-card-section>
            ...
            <q-card-section>
                ...
                >
                    ...
                    >
                        <q-card-section class="q-py-sm">
                            ...
                            <div class="q-mt-sm">
                                <q-btn
                                    :label="course.alreadyImported ? 'Use Course' : 'Import'"
                                    color="primary"
                                    dense
                                    size="sm"
                ...
                >
                    ...
                    <template #body-cell-actions="slotProps">
                        <q-td :props="slotProps">
                            <q-btn
                                :label="slotProps.row.alreadyImported ? 'Use Course' : 'Import'"
                                color="primary"
                                dense
                                size="sm"
    ...
    <!-- Import Options Dialog (for variable-unit courses) -->
    <q-dialog
    ...
    >
        <q-card style="min-width: 350px">
            ...
            <q-card-actions align="right">
                ...
                />
                <q-btn
                    :label="selectedBannerCourse?.alreadyImported ? 'Use Course' : 'Import'"
                    color="primary"
                    :loading="isImporting"
                    :disable="!canImport"
                    @click="doImport"
...
async function searchCourses() {
    ...
    try {
        searchResults.value = await courseService.searchBannerCoursesForSelf(props.termCode, {
...
function startImport(course: BannerCourseDto) {
    ...
    // For fixed-unit courses that are already imported, just emit the result
    if (course.alreadyImported && !course.isVariableUnits) {
        // Need to get the course ID - do the import which returns existing course
        doImport()
        return
    }

    // For variable-unit courses or new imports, show the options dialog
...
async function doImport() {
    ...
    try {
        ...
        if (result.success && result.course) {
            ...
            // Show message if course was already imported
